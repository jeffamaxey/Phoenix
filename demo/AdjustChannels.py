...
class TestAdjustChannels(wx.Panel):
    def __init__(self, parent, log):
        ...
        sliderred= wx.Slider(self, wx.ID_ANY, 100, 0, 200, size=(150, -1), style = wx.SL_HORIZONTAL | wx.SL_AUTOTICKS | wx.SL_LABELS)
        ...
        ctrlsizer.Add(label, 0, wx.ALL, 5)
        slidergreen= wx.Slider(self, wx.ID_ANY, 100, 0, 200, size=(150, -1), style = wx.SL_HORIZONTAL | wx.SL_AUTOTICKS | wx.SL_LABELS)
        ...
        ctrlsizer.Add(label, 0, wx.ALL, 5)
        sliderblue= wx.Slider(self, wx.ID_ANY, 100, 0, 200, size=(150, -1), style = wx.SL_HORIZONTAL | wx.SL_AUTOTICKS | wx.SL_LABELS)
        ...
        ctrlsizer.Add(label, 0, wx.ALL, 5)
        slideralpha= wx.Slider(self, wx.ID_ANY, 100, 0, 200, size=(150, -1), style = wx.SL_HORIZONTAL | wx.SL_AUTOTICKS | wx.SL_LABELS)
